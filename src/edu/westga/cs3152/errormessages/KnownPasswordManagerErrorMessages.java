...
public final class KnownPasswordManagerErrorMessages {
	...
	public static final String CANNOT_GET_EMPTY_KNOWN_PASSWORD = "Cannot get a known password is the encrypted version to get is empty";
	...
	public static final String CANNOT_CHECK_IF_EMPTY_ENCRYPTED_PASSWORD_IS_CONTAINED = "Cannot check if the encrypted password is contained if it is empty";
	...
	public static final String CANNOT_CHECK_IF_EMPTY_UNENCRYPTED_PASSWORD_IS_CONTAINED = "Cannot check if the unencrypted password is contained if it is empty";
	...
	public static final String CANNOT_REMOVE_EMPTY_PASSWORD = "Cannot remove a password if it is empty";
}
